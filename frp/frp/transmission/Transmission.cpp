...
namespace frp {
    namespace transmission {
        Transmission::Transmission(const std::shared_ptr<frp::threading::Hosting>& hosting, const std::shared_ptr<boost::asio::io_context>& context, const std::shared_ptr<boost::asio::ip::tcp::socket>& socket) noexcept
            : disposed_(false)
            , hosting_(hosting)
            , context_(context)
            , socket_(socket)
        ...
        frp::net::IPEndPoint Transmission::GetLocalEndPoint() noexcept {
            return localEP_;
        }

        frp::net::IPEndPoint Transmission::GetRemoteEndPoint() noexcept {
            return remoteEP_;
        }
