...
#include <frp/transmission/templates/SslSocket.hpp>
#include <frp/transmission/templates/WebSocket.hpp>
...
namespace frp {
    namespace transmission {
                        ...
                        [reference, this](const boost::system::error_code& ec_) noexcept {
                            ...
                            ssl_socket->async_shutdown(
                                [reference, this, ssl_socket](const boost::system::error_code& ec_) noexcept {
                                    Transmission::Dispose();
                                    frp::net::Socket::Closesocket(ssl_socket->next_layer());
                                });
                        });
                }
            }
        ...
        bool SslWebSocketTransmission::HandshakeAsync(HandshakeType type, const BOOST_ASIO_MOVE_ARG(HandshakeAsyncCallback) callback) noexcept {
            ...
            class AcceptSslvWebSocket final : public frp::transmission::templates::WebSocket<SslvWebSocket> {
            public:
            ...
            class AsyncSslvWebSocket final : public frp::transmission::templates::SslSocket<SslvWebSocketPtr> {
            public:
