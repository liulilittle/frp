...
namespace frp {
    namespace net {
        ...
        bool Socket::OpenAcceptor(
            ...
            frp::net::Socket::AdjustDefaultSocketOptional(handle, false);
            frp::net::Socket::SetTypeOfService(handle);
            frp::net::Socket::SetSignalPipeline(handle, false);
            frp::net::Socket::SetDontFragment(handle, false);
            frp::net::Socket::ReuseSocketAddress(handle, listenPort);
        ...
        void Socket::AdjustSocketOptional(const boost::asio::ip::tcp::socket& socket, bool fastOpen, bool noDealy) noexcept {
            ...
            frp::net::Socket::SetSignalPipeline(handle, false);
            frp::net::Socket::SetDontFragment(handle, false);
            frp::net::Socket::ReuseSocketAddress(handle, true);
