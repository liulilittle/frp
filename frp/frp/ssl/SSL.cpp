#include <frp/ssl/root_certificates.hpp>
...
namespace frp {
    namespace ssl {
        ...
        bool SSL::VerifySslCertificate(
            ...
            typedef frp::io::File                       File;
            typedef frp::io::FileAccess                 FileAccess;
            ...
            std::shared_ptr<boost::asio::ssl::context> ssl_context = make_shared_object<boost::asio::ssl::context>(
                frp::ssl::SSL::SSL_S_METHOD(frp::ssl::SSL::SSL_METHOD::ssl));
            if (!ssl_context) {
                return false;
            }
        ...
        std::shared_ptr<boost::asio::ssl::context> SSL::CreateServerSslContext(
            ...
            std::shared_ptr<boost::asio::ssl::context> ssl_context = make_shared_object<boost::asio::ssl::context>(
                frp::ssl::SSL::SSL_S_METHOD(method));
            if (!ssl_context) {
                return NULL;
            }
        ...
        std::shared_ptr<boost::asio::ssl::context> SSL::CreateClientSslContext(
            ...
            const std::string& ciphersuites) noexcept {
            std::shared_ptr<boost::asio::ssl::context> ssl_context = make_shared_object<boost::asio::ssl::context>(
                frp::ssl::SSL::SSL_C_METHOD(frp::ssl::SSL::SSL_METHOD::tlsv13));
            if (!ssl_context) {
                return NULL;
            }
